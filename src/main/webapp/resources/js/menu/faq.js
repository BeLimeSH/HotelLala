...
// const actitle = document.querySelectorAll(".accordion-container")[0];

// actitle.addEventListener("click",function(){
//     up.classList.toggle("exit");
//     down.classList.toggle("active");

// });

// const down1 = document.querySelectorAll('.down')[0];
// const up1 = document.querySelectorAll('.up')[0];
...
const inner4 = document.getElementsByClassName('inner')[3];
