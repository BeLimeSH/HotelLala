...
public class SendEmailServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String subject = "[HOTELLALA] 회원 가입 이메일 인증번호"; // 제목
		String fromEmail = "nambawon1@gmail.com"; // 보내는 사람으로 표시될 이메일
		...
		String toEmail = inputEmail; // 받는사람, 콤마(,)로 여러개 나열 가능
	      ...
	      try {
	         ...
	         sb.append("<h3>[HOTELLALA] 회원 가입 인증 번호입니다.</h3>\n");
	         sb.append("<h3>인증 번호 : <span style='color:blue'>"+cNumber+"</span></h3>\n");
//	         sb.append("<img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSb4zYhOqWg3UAI2aFrY7hH2brTUqIOUsE0vQ&usqp=CAU'>);
	         sb.append("<img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSb4zYhOqWg3UAI2aFrY7hH2brTUqIOUsE0vQ&usqp=CAU'>");
